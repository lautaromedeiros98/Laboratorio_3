function SignoZodiaco(fecha:string):string
{
    var dia:number = parseInt(fecha.split("-")[0]);
    var mes:number = parseInt(fecha.split("-")[1]);
    var año:number = parseInt(fecha.split("-")[2]);
